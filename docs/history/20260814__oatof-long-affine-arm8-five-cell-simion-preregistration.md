...
机器campaign唯一身份为
[`canonical_long_affine_arm8_width_numerics_n1000_campaign`](../../integrations/rf_multipole_ion_optics_to_single_reflection_oa_tof_mass_analyzer/config/diagnostics/canonical_long_affine_arm8_width_numerics_n1000_campaign.json)。
