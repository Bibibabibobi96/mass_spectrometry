...
参考程序先扫描有效区间寻找符号变化，再使用二分法；不依赖 SciPy，也不以未经检查的 Newton 初值直接发布结果。
...
3. R. Stein, “Space and velocity focusing in time-of-flight mass spectrometers,” *International Journal of Mass Spectrometry and Ion Physics*, 14, 355–364 (1974), DOI: `10.1016/0020-7381(74)80008-2`。
