...
assert(strcmp(requiredText(runConfig,'project'),'rf_quadrupole_ion_optics'), ...
...
assert(requiredFinite(staticElectrodes,'entrance_aperture_plate_and_connector_V')==0 && ...
    requiredFinite(staticElectrodes,'exit_outer_enclosure_and_connector_V')==0 && ...
    requiredFinite(staticElectrodes,'physical_detector_V')==0, ...
