...
[ordered]@{schema_version=1;run_id=$RunId;project='rf_quadrupole_ion_optics';mode='pa_field_convergence';project_root=$projectRoot;inputs=[ordered]@{resolved_design='config/resolved_design_official.json'};formal_gate_passed=$false;cell_mm=$CellMm} |
