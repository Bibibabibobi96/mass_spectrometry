...
RELATIVE_PATHS = (
    r"projects\rf_quadrupole_ion_optics\workflows\__init__.py",
    r"projects\rf_quadrupole_ion_optics\workflows\interface_readiness\__init__.py",
    r"projects\rf_quadrupole_ion_optics\workflows\interface_readiness\generate_particle_table.py",
    r"projects\rf_quadrupole_ion_optics\workflows\interface_readiness\particle_source_policy.py",
    r"projects\rf_quadrupole_ion_optics\analysis\paired_particle_source_bundle.py",
...
GATE_VALIDATOR_RELATIVE_PATH = (
    r"projects\rf_quadrupole_ion_optics"
...
class FrozenParticlePolicyPackageTests(unittest.TestCase):
    ...
    def test_comsol_runner_freezes_analysis_namespace_modules_without_init(
        ...
        self.assertNotIn(
            r"projects\rf_quadrupole_ion_optics\analysis\__init__.py",
            source,
        )
...
$module = 'projects.rf_quadrupole_ion_optics.workflows.interface_readiness.generate_particle_table'
$arguments = @(
        {arguments}
    )
$requiredModules = @(
