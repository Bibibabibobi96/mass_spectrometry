...
EXPECTED_PATHS = {
    "s2_passive_connector": {
        "projects/single_reflection_oa_tof_mass_analyzer/config/baseline.json",
        "projects/single_reflection_oa_tof_mass_analyzer/comsol/oatof_build_accelerator_geometry.m",
        "projects/single_reflection_oa_tof_mass_analyzer/analysis/rf_handoff_adapter.py",
        "projects/rf_quadrupole_ion_optics/analysis/migrate_legacy_component_particle_state.py",
        "projects/rf_quadrupole_ion_optics/config/rf_to_oatof_interface_stages.json",
        "projects/rf_quadrupole_ion_optics/config/rf_to_oatof_shared_physical_port_joint_geometry.json",
        "projects/rf_quadrupole_ion_optics/config/resolved_design_official.json",
    ...
    "s3_pulse_capture": {
        ...
        "projects/rf_quadrupole_ion_optics/config/resolved_design_official.json",
        "projects/rf_quadrupole_ion_optics/config/rf_to_oatof_s2_dependencies.json",
        "projects/rf_quadrupole_ion_optics/analysis/derive_shared_centroid_pulse_time.py",
        "projects/rf_quadrupole_ion_optics/analysis/plot_shared_pulse_geometry_snapshot.py",
        "projects/rf_quadrupole_ion_optics/analysis/audit_s3_pulse_chain.py",
        "projects/rf_quadrupole_ion_optics/analysis/build_s3_local_exit_component_state.py",
        "common/contracts/rigid_transform.py",
        "common/contracts/particle_physics.py",
        "common/contracts/component_particle_state.py",
        "common/contracts/schemas/component_particle_state.schema.json",
    ...
    "s3_end_to_end": {
        ...
        "projects/single_reflection_oa_tof_mass_analyzer/config/simion_stable_entry.json",
        "projects/single_reflection_oa_tof_mass_analyzer/analysis/build_handoff_pulse_program.py",
        ...
        "projects/rf_quadrupole_ion_optics/analysis/migrate_legacy_component_particle_state.py",
        "projects/rf_quadrupole_ion_optics/config/rf_to_oatof_s2_dependencies.json",
        "projects/rf_quadrupole_ion_optics/analysis/build_simion_input_from_canonical.py",
        "projects/rf_quadrupole_ion_optics/analysis/analyze_s3_end_to_end.py",
        "projects/rf_quadrupole_ion_optics/analysis/validate_oatof_formal_analyzer_release.py",
        "projects/rf_quadrupole_ion_optics/analysis/build_oatof_handoff.py",
        "common/contracts/rigid_transform.py",
        "common/contracts/particle_physics.py",
        "common/contracts/component_particle_state.py",
...
class DependencyContractTests(unittest.TestCase):
    ...
    def test_frozen_self_contract_survives_live_contract_drift(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            inputs = root / "inputs"
            relative = Path(
                "projects/rf_quadrupole_ion_optics/config/"
            ...
            dependency = {
                ...
                "provider_project": "rf_quadrupole_ion_optics",
                "provider_repo_path": "projects/rf_quadrupole_ion_optics",
    ...
    def test_snapshot_requires_only_selected_consumer_sources_to_exist(self) -> None:
        ...
        e2e_dependency["source_repo_path"] = "projects/single_reflection_oa_tof_mass_analyzer/config/not_frozen.json"
        e2e_dependency["frozen_filename"] = (
            "runtime_snapshot/projects/single_reflection_oa_tof_mass_analyzer/config/not_frozen.json"
        )
...
class S2SnapshotRunnerTests(unittest.TestCase):
    ...
    def test_freeze_precedes_every_snapshot_python_consumer(self) -> None:
        ...
        resolver_index = self.runner.index(
            "'projects.rf_quadrupole_ion_optics.analysis.resolve_s2_connector_case'"
        )
        spatial_index = self.runner.index(
            "'projects.rf_quadrupole_ion_optics.analysis.resolve_spatial_registration'"
        )
        validator_index = self.runner.index(
            "'projects.rf_quadrupole_ion_optics.analysis.validate_s2_passive_connector'"
        )
        handoff_index = self.runner.index(
            "'projects.rf_quadrupole_ion_optics.analysis.build_oatof_handoff'"
        )
    ...
    def test_snapshot_imports_survive_poisoned_provider_tree(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            modules = (
                ...
                "projects.rf_quadrupole_ion_optics.analysis.validate_s2_passive_connector",
                "projects.rf_quadrupole_ion_optics.analysis.build_oatof_handoff",
                "projects.single_reflection_oa_tof_mass_analyzer.analysis.rf_handoff_adapter",
            ...
            validation = subprocess.run(
                [
                    ...
                    "--reference-root",
                    str(snapshot / "projects/rf_quadrupole_ion_optics"),
