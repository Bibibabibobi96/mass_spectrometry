...
from projects.rf_quadrupole_ion_optics.analysis import validate_s3_pulse_capture as module
...
class S3PulseCaptureContractTests(unittest.TestCase):
    ...
    def test_snapshot_python_rejects_live_provider_poison(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            analysis = snapshot / "projects/rf_quadrupole_ion_optics/analysis"
