...
$artifactRoot = Join-Path $workspaceRoot `
    'artifacts\projects\rf_quadrupole_ion_optics'
$python = if ($PythonExe) {
...
try {
    ...
    $runtimeFiles = @(
        ...
        'projects\rf_quadrupole_ion_optics\workflows\mass_filter_reference\__init__.py',
        'projects\rf_quadrupole_ion_optics\workflows\mass_filter_reference\evaluate_comparison.py',
        'projects\rf_quadrupole_ion_optics\workflows\mass_filter_reference\theory.py',
    ...
    $module = 'projects.rf_quadrupole_ion_optics.workflows.' +
        'mass_filter_reference.evaluate_comparison'
    $requiredModules = @(
        'projects.rf_quadrupole_ion_optics.workflows',
        'projects.rf_quadrupole_ion_optics.workflows.mass_filter_reference',
        $module,
        'projects.rf_quadrupole_ion_optics.workflows.mass_filter_reference.theory',
        'common.multipole',
