...
assert(strcmp(contract.identity.project_id,'rf_quadrupole_ion_optics') && ...
...
mustBeNear(interfaces.exit.aperture_plate_upstream_face_z_mm,enclosure.exit_enclosure_z_min_mm, ...
    'exit plate z-min');
mustBeNear(interfaces.exit.aperture_plate_downstream_face_z_mm,enclosure.exit_front_wall_end_z_mm, ...
    'exit plate z-max');
mustBeNear(interfaces.exit.census_plane_z_mm,enclosure.vacuum_z_max_mm, ...
    'observation plane');
end
