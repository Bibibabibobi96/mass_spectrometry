...
无加速N=100基线已在全部四段杆施加RF并按81.1 mm近接口统计面计数，RF-on为100/100、zero-RF为
21/100；它只证明基线功能分类。基线pilot后、refined运行前登记的v2空间敏感性档为全局
cell `0.4→0.3 mm`，时间档固定`0.3 mm`并将`40→80`步/周期；两档尚未运行。旧分段杆、
