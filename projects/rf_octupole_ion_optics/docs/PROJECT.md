...
中继续使用正式飞行管、反射器和探测器。杆端至加速器罩为1.000 mm，过渡段完整径向包围，3 V多极杆
屏蔽与0 V加速器罩之间保留0.500 mm绝缘缝。N=1000得到`571→491→491`，总检测传输49.1%；相对
...
`20260804_143000__analysis__cross__single-vs-staged__n1000`；当前仍是单网格诊断，不表示单流程更准确。
