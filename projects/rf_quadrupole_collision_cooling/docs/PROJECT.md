...
|---|---:|---:|---|---|
| 默认 | 1 mm | 36.112152843 | `100→61→31→31→7` | `20260724_195150__sim__cross__rf-oatof-s3-end-to-end-gap1__n100` |
...
用end-to-end run内的冻结verifier强校验三阶段manifest。迁移后的1 mm真实链已由
`20260724_190234__sim__comsol__rf-oatof-s2-connector-gap1__n100`、
`20260724_190234__sim__comsol__rf-oatof-s3-pulse-gap1__n100`和
`20260724_195150__sim__cross__rf-oatof-s3-end-to-end-gap1__n100`完成商业复验：S2为`61/100`，
