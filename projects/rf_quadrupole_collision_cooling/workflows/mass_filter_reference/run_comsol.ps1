...
try {
  ...
  & $package.python -m `
    projects.rf_quadrupole_collision_cooling.workflows.mass_filter_reference.prepare_comsol_scan `
  ...
  $runConfiguration=[ordered]@{
    ...
    run_id=$RunId;project='rf_quadrupole_collision_cooling';mode='mass_filter_reference';project_root=$repoRoot
    inputs=[ordered]@{
  ...
  & $package.python -m `
    projects.rf_quadrupole_collision_cooling.workflows.mass_filter_reference.evaluate_comsol `
