...
function segment.fast_adjust()
  adj_elect01, adj_elect02, adj_elect03, adj_elect04, adj_elect05 = V_m1,V_m2,V_m3,V_m4,V_m5
  adj_elect06, adj_elect07, adj_elect08, adj_elect09, adj_elect10 = V_m1,V_m2,V_m3,V_m4,V_m5
  adj_elect11, adj_elect12 = V_stripe_1,V_stripe_1
  adj_elect13, adj_elect14 = V_stripe_2,V_stripe_2
...
function segment.terminate()
  print(string.format('MRTOF_EVENT terminal ion=%d t_us=%.12g x_mm=%.12g y_mm=%.12g z_mm=%.12g turns=%d central_crossings=%d',
