...
class FirstPrismL0Test(unittest.TestCase):
    ...
    def test_derives_total_energy_partition_triangle_crossings_and_static_seed(self) -> None:
        ...
        self.assertEqual(result.entry_position_project_mm, (0.0, -45.0, 0.0))
        ...
        self.assertEqual(result.triangle_entry_project_mm, (0.0, -45.0, -62.828))
        self.assertEqual(result.triangle_exit_project_mm, (0.0, -45.0, -67.172))
    ...
    def test_rejects_wrong_station_ray_plane_and_slot_contract(self) -> None:
        for mutate in (
            ...
            lambda contract: contract["prism_transport"]["first_prism"]["entry_reference"].__setitem__("position_authority", "manual_duplicate"),
