...
modelPath = fullfile(paths.modelWorkspaceDir, 'ElectronGun_Coil.mph');
savePath  = fullfile(paths.modelWorkspaceDir, 'ElectronGun_Coil_ES.mph');
...
% just the true vacuum one (see COMSOL_API.md §7.2/§7.12).
