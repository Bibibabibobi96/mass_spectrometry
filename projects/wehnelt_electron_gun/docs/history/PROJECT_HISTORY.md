...
> 根[COMSOL API](../../../../docs/COMSOL_API.md#磁场与线圈)和
> [COMSOL排错](../../../../docs/COMSOL_DEBUGGING.md#磁场线圈和磁力)中的相关章节（本项目的螺旋
...
| 层级 | 权威对象 | 职责 |
|---|---|---|
| 当时维护的源代码 | 三份`*_coil_transverse.m`脚本 | 归档时点选定的电子枪物理流水线 |
...
`83D216A9B4CC4FBE3E9DFF1934900FE533FE895D1C3B835EFBAADC13D56F0BDF`。这些身份只属于归档证据，
不恢复现行Formal资格。
