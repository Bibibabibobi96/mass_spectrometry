...
if ~exist(paths.resultsDir, 'dir'), mkdir(paths.resultsDir); end
save(fullfile(paths.resultsDir, 'wehnelt_sweep_results.mat'), 'results');
fprintf('\nSUCCESS: sweep complete, results saved to %s\n', ...
    fullfile(paths.resultsDir, 'wehnelt_sweep_results.mat'));
end
