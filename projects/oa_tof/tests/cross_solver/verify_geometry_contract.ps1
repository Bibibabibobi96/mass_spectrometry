...
Assert-Contains $lua 'ion_pz_mm<=accelerator_grid2_z_mm' 'SIMION accelerator priority over shield PA'
...
Assert-Contains $acceleratorGem 'e(8) { fill { within { centered_box3D(0,0,19.83, $(shield_inner_width),$(shield_inner_width),$(mmgu_z)) } } }' 'SIMION accelerator exit grid entity'
