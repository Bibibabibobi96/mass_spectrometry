...
每档独立冷启动时，N=100/300/1000的完整墙钟分别为`444.240/518.625/774.917 s`，其中`std2`
粒子阶段为`316.004/390.247/635.909 s`，全部100%到达。三点拟合的完整固定项约`407.96 s`，
每增加一个粒子的边际项约`0.3671 s`；因此从N=100增至N=300只增加约16.7%墙钟，却把样本数扩大
