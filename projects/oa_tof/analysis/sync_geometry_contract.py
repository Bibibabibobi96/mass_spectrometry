...
def generated_adjustables(contract: dict) -> str:
    ...
    values = [
        ...
        ("detector_tstep_enable", int(marker["near_plane_tstep_default_enabled"])),
        ("detector_tstep_window_mm", marker["front_margin_z_mm"]),
        ("detector_tstep_max_dz_mm", marker["near_plane_max_step_z_mm"]),
