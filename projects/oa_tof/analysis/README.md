...
```powershell
.\.venv\Scripts\python.exe -m projects.oa_tof.analysis.reference_analysis single `
...
```powershell
.\.venv\Scripts\python.exe -m projects.oa_tof.analysis.reference_analysis simion-recording `
