...
from projects.oa_tof.analysis.compile_candidate_design import write_candidate
from projects.oa_tof.analysis.prepare_candidate_run import prepare_candidate_run
...
def prepare_execution(
    ...
    *,
    ...
    artifact_root = (
        ...
        or WORKSPACE_ROOT / "artifacts" / "projects" / "oa_tof"
    ).resolve()
    request = request_path.resolve(strict=True)
