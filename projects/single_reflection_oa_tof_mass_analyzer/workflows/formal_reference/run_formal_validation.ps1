...
$artifactRoot = Join-Path (Split-Path -Parent $repoRoot) 'artifacts\projects\single_reflection_oa_tof_mass_analyzer'
...
[ordered]@{
  schema_version=1; run_id=$RunId; project='single_reflection_oa_tof_mass_analyzer'; mode='formal_cross_solver_validation'
...
& $python -m projects.single_reflection_oa_tof_mass_analyzer.analysis.reference_analysis compare $comsolCsv $simionCsv `
