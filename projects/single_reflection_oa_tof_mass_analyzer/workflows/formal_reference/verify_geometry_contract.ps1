...
Assert-Contains $acceleratorGem '# local interface_port_enable = var.interface_port_enable or 0' 'SIMION formal-default closed interface port'
...
Assert-Contains $comsol "geom1.feature.create('accelshieldPort', 'Block')" 'COMSOL candidate interface-port cut'
Assert-Contains $comsol "shieldCutInputs{end+1} = 'accelshieldPort'" 'COMSOL candidate port subtraction'
