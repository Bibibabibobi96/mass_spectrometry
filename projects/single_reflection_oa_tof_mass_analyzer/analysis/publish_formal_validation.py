...
ARTIFACTS = REPO.parent / "artifacts" / "projects" / "single_reflection_oa_tof_mass_analyzer"
...
def main() -> None:
    ...
    mph = ARTIFACTS / "formal/comsol/single_reflection_oa_tof_mass_analyzer__model.mph"
