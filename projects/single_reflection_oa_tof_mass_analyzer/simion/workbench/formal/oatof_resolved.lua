...
return {
  ...
  inputs={
    ...
    baseline_sha256="4248B3D34CF3784F3F00FF6E64B0EB734CD20ECF1D82DEDF9A7BA11C7EF98B67",
  ...
  grid_policy={
    baseline="zero-grid-unit-thick one-row full-aperture 100%-transmission ideal electrode sheet",
