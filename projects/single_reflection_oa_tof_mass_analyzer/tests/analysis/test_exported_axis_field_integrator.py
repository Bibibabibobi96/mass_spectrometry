...
class ExportedAxisFieldIntegratorTests(unittest.TestCase):
    ...
    def test_c3_export_is_top_level_and_reproduces_post_pulse_fast_adjust(self) -> None:
        ...
        self.assertIn("ai.pa:fast_adjust(pa_adjustments", source)
        self.assertIn("oi.pa:fast_adjust(pa_adjustments", source)
        ...
        self.assertIn("simion.wb:epotential", source)
        self.assertIn("simion.wb:efield", source)
