...
$runConfig = [ordered]@{
  ...
  run_id=$RunId; project='single_reflection_oa_tof_mass_analyzer'; mode='simion_source_build_equivalence'
...
& $python -m projects.single_reflection_oa_tof_mass_analyzer.analysis.reference_analysis compare (Join-Path $runDir 'reference_particles.csv') `
