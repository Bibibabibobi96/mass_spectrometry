...
每次投稿前按下列格式逐项填写审查记录。此处是待填写模板，不是已完成审计或投稿资格证据；
每项应在“相同／部分重合／完全新增”中择一，并引用具体图、数据或方法。确实不适用时写“不适用”
及原因，不能用空白代替判断。

```text
中心假设：<重合类别>；证据/说明：<来源与判断>
核心方法：<重合类别>；证据/说明：<来源与判断>
主要数据：<重合类别>；证据/说明：<来源与判断>
主图：<重合类别>；证据/说明：<来源与判断>
主结论：<重合类别>；证据/说明：<来源与判断>
分析终点：<重合类别>；证据/说明：<来源与判断>
```
