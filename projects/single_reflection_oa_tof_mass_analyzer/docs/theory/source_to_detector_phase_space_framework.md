...
Formal 结论。双区／三区加速器局部公式由独立加速器项目维护，反射器与整机耦合由本目录维护；
完整导航见[理论入口](README.md)。
...
- [1. 权威边界与理论标签](#1-权威边界与理论标签)
- [2. 三个时刻必须分开](#2-三个时刻必须分开)
- [3. 坐标、独立状态与无量纲化](#3-坐标独立状态与无量纲化)
- [4. 完整source-to-detector映射](#4-完整source-to-detector映射)
- [5. 局部到达时间张量](#5-局部到达时间张量)
- [6. 多维条件流形与有限厚度](#6-多维条件流形与有限厚度)
- [7. 一般N区正交加速器接口](#7-一般n区正交加速器接口)
- [8. 三维轨迹和探测事件灵敏度](#8-三维轨迹和探测事件灵敏度)
- [9. 工程扰动、测量链与良率](#9-工程扰动测量链与良率)
- [10. 性能向量与有限分布设计](#10-性能向量与有限分布设计)
- [11. 模型层级](#11-模型层级)
- [12. 与现有组件文档的关系](#12-与现有组件文档的关系)
- [13. 禁止性结论](#13-禁止性结论)
