...
本目录存放COMSOL官方PDF手册，作为离线原始参考。它们不是本项目的经验文档，不建议在每次任务开始时全文阅读；只有当`../COMSOL_MATLAB_API手册.md`、`../COMSOL_调试方法论.md`或具体`项目_*.md`没有覆盖某个问题时，再按问题类型查对应PDF。
...
- 如果从官方文档中确认了一个本项目常用的具体调用或陷阱，应把提炼后的结论写入`../COMSOL_MATLAB_API手册.md`或`../COMSOL_调试方法论.md`，并保留简短来源说明。