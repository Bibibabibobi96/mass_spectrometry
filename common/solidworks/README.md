...
对应项目文档。工具链版本与正式执行入口统一见[操作指南](../../docs/OPERATIONS.md)。

PowerShell 入口通过[`resolve_solidworks_2022.ps1`](resolve_solidworks_2022.ps1)、Python 入口通过[`installation.py`](installation.py)解析同一
