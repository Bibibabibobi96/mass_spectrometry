...
def build_inputs(
    ...
    round_rods = {
        ...
        "grounded_enclosure_mm": {
            ...
            "shield_inner_radius": float(geometry["exit_enclosure_inner_half_width"]),
            "shield_outer_radius": float(geometry["exit_enclosure_outer_half_width"]),
            "vacuum_z_min": 0.0,
        ...
        "interfaces_mm": {
            ...
            "entrance_aperture_radius": float(interfaces["entrance"]["aperture_radius_mm"]),
            "entrance_connector_length": entrance_connector_length,
            "entrance_connector_shape": "rectangular_bore",
            "exit_plate_z_min": float(interfaces["exit"]["plate_z_min_mm"]),
            "exit_plate_z_max": float(interfaces["exit"]["plate_z_max_mm"]),
            "exit_aperture_radius": float(interfaces["exit"]["aperture_radius_mm"]),
            "exit_connector_length": exit_connector_length,
            "exit_connector_shape": "rectangular_bore",
