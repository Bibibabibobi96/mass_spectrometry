...
context = struct( ...
    ...
    'rf_ground_tags', {{'rfshield','rfentrance'}}, ...
    'rf_rod_tags', {rfRodTags}, ...
    'rf_rod_electrode_groups', [rfGeometry.rod_array.rods.electrode_group], ...
    'rf_rod_common_mode_V', resolved_rod_potentials(rf, rfGeometry.rod_array.rods), ...
...
assert(strcmp(terminal.owner,'downstream') && ...
    strcmp(terminal.terminal_profile_id,'oatof_shield_entry_gap1mm') && ...
