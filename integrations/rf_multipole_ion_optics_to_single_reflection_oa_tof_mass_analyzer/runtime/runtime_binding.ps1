...
function Test-RfOatofImplementationPath {
  ...
  $externalProviderPaths = @{
    ...
    shared_simion_resource_scheduler = 'common/multipole/resource_budget_support.ps1'
...
function Resolve-RfOatofRuntimeBinding {
  ...
  if ([int]$binding.schema_version -ne 4 -or
  ...
  $implementationBindingPath = Join-Path $repo (
