...
$artifactRoot = Join-Path $projectRoot 'artifacts\components\mass_analyzers\oa_tof\dual_stage_ringstack'
...
$geometryGate = Join-Path $repoRoot 'components\mass_analyzers\oa_tof\dual_stage_ringstack\tests\cross_solver\verify_geometry_contract.ps1'
...
$distributions = @(
  @{ Name='all';         HX=0.5; HY=0.5; HZ=0.5; ES=1.0 },
  @{ Name='z_only';      HX=0.0; HY=0.0; HZ=0.5; ES=0.0 },
  @{ Name='xy_only';     HX=0.5; HY=0.5; HZ=0.0; ES=0.0 },
  @{ Name='energy_only'; HX=0.0; HY=0.0; HZ=0.0; ES=1.0 }
)
$modes = @(
...
$summaries | Sort-Object Distribution,Mode | Format-Table Distribution,Mode,Hit,EfficiencyPct,MeanTofUs,StdTofNs,Resolution2Sigma,MaxCrossingRadiusMm -AutoSize
