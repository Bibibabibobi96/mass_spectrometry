...
tag = 'ModelPole4';
modelPath = 'C:\Users\Liao\PycharmProjects\PythonProject\comsol_models\Multipole4.mph';
...
savePath = sprintf('C:\\Users\\Liao\\PycharmProjects\\PythonProject\\comsol_models\\Multipole4_CPT_%s.mph', strrep(label,' ','_'));
model.save(savePath);
